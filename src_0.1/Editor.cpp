...
Editor::Editor() : TextReceiver( sf::Vector2f( 0.f , 0.f ) ) , vScroll( 0.f , 0.f ) {
...
void Editor::setPosition( const sf::Vector2f& position ) {
	...
	vScroll.setPosition( getPosition().x + Clickable::getSize().x - vScroll.getSize().x - 1 , getPosition().y + 1 );
}
