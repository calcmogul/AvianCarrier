...
class diff_match_patch {
 ...
 public:
   ...
   */
  std::list<Diff> diff_main(const std::string &text1, const std::string &text2);
   ...
   * @return Linked List of Diff objects.
   */
  std::list<Diff> diff_main(const std::string &text1, const std::string &text2, bool checklines);
   ...
   */
 private:
  std::list<Diff> diff_main(const std::string &text1, const std::string &text2, bool checklines, clock_t deadline);
   ...
   */
 private:
  std::list<Diff> diff_compute(std::string text1, std::string text2, bool checklines, clock_t deadline);
   ...
   */
 private:
  std::list<Diff> diff_lineMode(std::string text1, std::string text2, clock_t deadline);
   ...
   */
 protected:
  std::list<Diff> diff_bisect(const std::string &text1, const std::string &text2, clock_t deadline);
   ...
   */
 private:
  std::list<Diff> diff_bisectSplit(const std::string &text1, const std::string &text2, int x, int y, clock_t deadline);
   ...
   */
 protected:
  std::list<QVariant> diff_linesToChars(const std::string &text1, const std::string &text2); // return elems 0 and 1 are QString, elem 2 is QStringList
   ...
   */
 private:
  std::string diff_linesToCharsMunge(const std::string &text, std::list<std::string> &lineArray,
   ...
   */
 private:
  void diff_charsToLines(std::list<Diff> &diffs, const std::list<std::string> &lineArray);
 ...
 protected:
   ...
   */
 protected:
  std::list<std::string> diff_halfMatch(const std::string &text1, const std::string &text2);
   ...
   */
 private:
  std::list<std::string> diff_halfMatchI(const std::string &longtext, const std::string &shorttext, int i);
 ...
 public:
   ...
   */
 public:
  std::list<Diff> diff_fromDelta(const std::string &text1, const std::string &delta);
 ...
 private:
   ...
   */
 protected:
  std::map<unsigned char, int> match_alphabet(const std::string &pattern);
 ...
 protected:
   ...
   */
 public:
  std::list<Patch> patch_make(const std::string &text1, const std::string &text2);
 ...
 public:
   ...
   */
 public:
  std::list<Patch> patch_make(const std::string &text1, const std::string &text2, const std::list<Diff> &diffs);
   ...
   */
 public:
  std::list<Patch> patch_make(const std::string &text1, const std::list<Diff> &diffs);
 ...
 public:
   ...
   */
 public:
  std::pair<std::string,std::vector<bool> > patch_apply(std::list<Patch> &patches, const std::string &text);
 ...
 private:
  static inline std::string safeMid(const std::string &str, int pos) {
    return (pos == str.length()) ? std::string("") : str.mid(pos);
  }
 ...
 private:
  static inline std::string safeMid(const std::string &str, int pos, int len) {
    return (pos == str.length()) ? std::string("") : str.mid(pos, len);
  }
};
